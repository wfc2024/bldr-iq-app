...
export const scopeOfWorkData: ScopeOfWork[] = [
  ...
  { group: 'Finishes', name: 'Lower Cabinets Only', unitType: 'lf', defaultUnitCost: 350, unitReasoning: getUnitReasoning('lf') },
  { group: 'Finishes', name: 'Upper and Lower Cabinets', unitType: 'lf', defaultUnitCost: 550, unitReasoning: getUnitReasoning('lf') },
  { group: 'Finishes', name: 'Plastic Laminate Counter Top', unitType: 'lf', defaultUnitCost: 165, unitReasoning: getUnitReasoning('lf') },
  ...
  { group: 'Plumbing', name: 'Plumbing - New Fixtures (toilets, sinks, floor drains, etc.)', unitType: 'each', defaultUnitCost: 3500, unitReasoning: getUnitReasoning('each') },
  ...
  { group: 'Electrical', name: 'Electrical - General Distribution', unitType: 'sqft', defaultUnitCost: 18, unitReasoning: getUnitReasoning('sqft') },
  { group: 'Electrical', name: 'Electrical - Lighting Allowance', unitType: 'sqft', defaultUnitCost: 3, unitReasoning: getUnitReasoning('sqft') },
