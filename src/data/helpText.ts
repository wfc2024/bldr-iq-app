...
export const projectTemplates: ProjectTemplate[] = [
  ...
  },
  {
    ...
    lineItems: [
      ...
      { scopeName: "10' Metal Stud Wall + Sheetrock", quantity: 0, notes: "Standard height walls for offices/conference rooms - measure linear feet" },
      ...
      { scopeName: "Electrical - General Distribution", quantity: 0, notes: "General electrical work - enter total square footage" },
      { scopeName: "Electrical - Lighting Allowance", quantity: 0, notes: "Lighting package - enter total square footage" },
  ...
  },
  {
    ...
    lineItems: [
      ...
      { scopeName: "10' Metal Stud Wall + Sheetrock", quantity: 0, notes: "Sales floor partitions and back office - measure linear feet" },
      ...
      { scopeName: "Electrical - General Distribution", quantity: 0, notes: "General electrical - enter total sqft" },
      { scopeName: "Electrical - Lighting Allowance", quantity: 0, notes: "Retail lighting - enter sqft for comprehensive lighting" },
      { scopeName: "Plumbing - New Fixtures (toilets, sinks, floor drains, etc.)", quantity: 0, notes: "Restroom plumbing - count fixtures" },
  ...
  },
  {
    ...
    lineItems: [
      ...
      { scopeName: "10' Metal Stud Wall + Sheetrock", quantity: 0, notes: "Dining area, kitchen, office partitions" },
      ...
      { scopeName: "Electrical - General Distribution", quantity: 0, notes: "Heavy electrical for kitchen equipment - enter sqft" },
      { scopeName: "Electrical - Lighting Allowance", quantity: 0, notes: "Dining and kitchen lighting - enter sqft" },
      { scopeName: "Plumbing - New Fixtures (toilets, sinks, floor drains, etc.)", quantity: 0, notes: "Kitchen sinks, prep sinks, hand sinks, restrooms - count all fixtures" },
