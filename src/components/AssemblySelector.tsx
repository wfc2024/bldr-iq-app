  ...
  return (
    <>
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        <DialogContent 
          className="w-full max-w-[calc(100vw-2rem)] max-h-[80vh] sm:max-h-[70vh] overflow-hidden flex flex-col"
          style={{ 
            width: window.innerWidth >= 640 ? '600px' : undefined,
            maxWidth: window.innerWidth >= 640 ? '600px' : 'calc(100vw - 2rem)'
          }}
        >
          <DialogHeader>
