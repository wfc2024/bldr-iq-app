...
export const scopeOfWorkData: ScopeOfWork[] = [
  ...
  { group: 'Plumbing', name: 'Tenant Improvement (new fixtures including necessary underground and overhead work)', unitType: 'each', defaultUnitCost: 3500, unitReasoning: getUnitReasoning('each') },
  { group: 'Mechanical', name: 'Relocated Grills / Registers / Diffusers (keep existing duct work)', unitType: 'each', defaultUnitCost: 150, unitReasoning: getUnitReasoning('each') },
  ...
  { group: 'Electrical', name: 'Tenant Improvement General Electrical Distribution', unitType: 'sqft', defaultUnitCost: 18, unitReasoning: getUnitReasoning('sqft') },
  { group: 'Electrical', name: 'Tentant Improvement Lighting Allowance', unitType: 'sqft', defaultUnitCost: 3, unitReasoning: getUnitReasoning('sqft') },
  { group: 'Electrical', name: 'Light Fixture Swap', unitType: 'each', defaultUnitCost: 300, unitReasoning: getUnitReasoning('each') },
  ...
  { group: 'Electrical', name: 'Low Voltage Allowance', unitType: 'lump sum', defaultUnitCost: 5000, unitReasoning: getUnitReasoning('lump sum') },
